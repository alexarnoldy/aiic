...
* *Providers of retail hardware and software solutions are facing challenges on multiple fronts.* These include retailers who want to extend the life of their legacy platforms, those who are exploring portable platforms, and those who are demanding more capabilities from in-store platforms. 
